...
// Wrapping iterator class that only consider elements that satisfy a given
// predicate. When moving to the next element of the iterator, the
// FilterIterator will iterate over the range until it finds an element that
// satisfies Predicate or reach the end of the iterator.
//
